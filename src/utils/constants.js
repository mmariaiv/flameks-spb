...
export const cardsList = [
	{
		...
		modalUrl: gbuModal,
		about:
			"Реконструкция здания Санкт-Петербургского ГБОУ ДОД СДЮШОР Пушкинского района. Выполнен монтаж систем отопления, водоснабжения и канализации.",
	},

	{
		...
		about:
			"Реконструкция Здания Вокзала г. Мариуполь. Ведется монтаж систем отопления, вентиляции, кондиционирования, водоснабжения и канализации.",
	},
	{
		url: Mitkovo,
	...
	},
	{
		...
		about:
			"Строительство Железнодорожной станции КУТУЗОВО (МЦД-4). Компанией Фламекс СПБ выполнен комплекс работ по устройству систем водоснабжения, водоотведения и кондиционирования.",
	},
	{
		url: Bank,
		modalUrl: BankModal,
		...
		alt: "ЦБ РФ",
		about:
			"В Северо-Западном управлении ЦБ РФ выполнен монтаж и проведены пуско-наладочные работы систем холодоснабжения трех серверных, а так же Ремонт (замена) подъёмно-секционных ворот АлютексProPlus ",
	},
	{
		url: NevskyTownHall,
		...
		alt: "Невская ратуша",
		about:
			"Компанией Фламекс СПБ выполнен монтаж систем отопления,  теплоснабжения и вентиляции корпуса 4.",
	},
];
